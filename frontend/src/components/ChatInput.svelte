...
<div class="flex-shrink-0 bg-white px-4 py-3 md:px-6 md:py-4 border-t border-slate-100 z-10">
  <div class="max-w-3xl mx-auto">
    <div class="relative bg-white rounded-2xl border border-slate-200 shadow-sm focus-within:shadow-md focus-within:border-teal-300 transition-all items-center">
      <textarea
        bind:value
      ...
      ></textarea>
      <div class="absolute right-2 bottom-4 flex items-center text-center gap-1">
